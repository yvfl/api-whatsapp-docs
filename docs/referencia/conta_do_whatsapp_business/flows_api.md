...
<!-- Scraped: 2026-03-10T21:58:02.387Z -->
...
```
curl --request POST \  --url 'https://graph.facebook.com/{Version}/{WABA-ID}/flows' \  --header 'Authorization: Bearer <Token>'
```
...
```
curl --request POST \  --url 'https://graph.facebook.com/{Version}/{WABA-ID}/migrate_flows' \  --header 'Authorization: Bearer <Token>'
```
...
```
curl --request POST \  --url 'https://graph.facebook.com/{Version}/{Flow-ID}' \  --header 'Authorization: Bearer <Token>'
```
...
```
curl --request GET \  --url 'https://graph.facebook.com/{Version}/{Flow-ID}/assets' \  --header 'Authorization: Bearer <Token>'
```
...
```
curl --request POST \  --url 'https://graph.facebook.com/{Version}/{Flow-ID}/assets' \  --header 'Authorization: Bearer <Token>'
```
