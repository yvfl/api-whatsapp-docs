<!-- Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/messages/video -->
<!-- Scraped: 2025-12-20T17:38:56.609Z -->

# Referência do webhook de mensagens de vídeo

Updated: 22 de out de 2025

Esta referência descreve os eventos de gatilho e o conteúdo da carga do webhook de **mensagens** da conta do WhatsApp Business para mensagens de vídeo.

## Gatilhos

-   Um usuário do WhatsApp envia um vídeo para a empresa.-   Um usuário do WhatsApp encaminha um vídeo para a empresa.-   Um usuário do WhatsApp envia um vídeo a uma empresa por meio de um anúncio de clique para o WhatsApp.
