...
<!-- Scraped: 2025-12-20T17:37:24.159Z -->

# Referência do webhook de mensagens de imagem

Updated: 22 de out de 2025

Esta referência descreve os eventos de gatilho e o conteúdo da carga do webhook de **mensagens** da conta do WhatsApp Business para mensagens com imagem.

## Gatilhos

-   Um usuário do WhatsApp envia uma imagem para a empresa.-   Um usuário do WhatsApp encaminha uma mensagem de imagem para a empresa.-   Um usuário do WhatsApp encaminha uma [mensagem com botão de resposta interativa para uma empresa](/documentation/business-messaging/whatsapp/messages/interactive-reply-buttons-messages).-   Um usuário do WhatsApp envia uma imagem para a empresa por meio de um anúncio de clique para o WhatsApp.
...
A propriedade `ctwa_clid` é omitida em mensagens originadas de um anúncio no Status do WhatsApp ([posicionamentos de anúncios no Status do WhatsApp](https://www.facebook.com/business/help/1074444721456755)).
