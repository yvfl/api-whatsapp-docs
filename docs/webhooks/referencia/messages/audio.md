<!-- Source: https://developers.facebook.com/documentation/business-messaging/whatsapp/webhooks/reference/messages/audio -->
<!-- Scraped: 2025-12-20T17:36:41.885Z -->

# Referência do webhook de mensagens de áudio

Updated: 22 de out de 2025

Esta referência descreve os eventos de gatilho e o conteúdo da carga do webhook de **mensagens** da conta do WhatsApp Business para mensagens com uma gravação de áudio.

## Gatilhos

-   Um usuário envia uma gravação ou um arquivo de áudio do WhatsApp para uma empresa.-   Um usuário do WhatsApp envia um arquivo ou uma gravação de áudio do WhatsApp a uma empresa por meio de um anúncio de clique para o WhatsApp.
...
Valor booliano que indica se o áudio é uma gravação feita com o recurso de gravação de voz do cliente do WhatsApp (`true`) ou não (`false`).
...
ID do ativo de mídia. É possível [fazer uma solicitação GET usando esse ID](/documentation/business-messaging/whatsapp/business-phone-numbers/media) para obter a URL do ativo e depois fazer uma solicitação GET na URL retornada (usando seu token de acesso) para acessar o ativo subjacente.
...
**Esta propriedade JSON será lançada para desenvolvedores de forma gradual nas próximas semanas, a partir de 12 de novembro de 2025. Talvez ela não esteja disponível para você imediatamente.**

URL da mídia. É possível consultar essa URL diretamente com o token de acesso para [baixar o ativo de mídia](/documentation/business-messaging/whatsapp/business-phone-numbers/media#download-media).
