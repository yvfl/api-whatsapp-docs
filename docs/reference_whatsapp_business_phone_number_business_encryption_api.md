...
<!-- Scraped: 2025-12-20T18:01:43.059Z -->
...
business\_public\_key\_signature\_statusBusinessPublicKeyVerificationStatus
...
```
curl --request POST \  --url 'https://graph.facebook.com/{Version}/{Phone-Number-ID}/whatsapp_business_encryption' \  --header 'Authorization: Bearer <Token>' \  --header 'Content-Type: multipart/form-data' \  --data '{  "business_public_key": "-----BEGIN PUBLIC KEY-----\nMIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA...\n-----END PUBLIC KEY-----\n"}'
```
