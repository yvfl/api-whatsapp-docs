...
<!-- Scraped: 2025-12-20T17:38:21.682Z -->

# Referência de webhook de mensagens com figurinha

Updated: 22 de out de 2025

Esta referência descreve os eventos de gatilho e o conteúdo da carga do webhook de **mensagens** da conta do WhatsApp Business para mensagens com figurinha.

## Gatilhos

-   Um usuário do WhatsApp envia uma figurinha para a empresa.-   Um usuário do WhatsApp envia uma figurinha a uma empresa por meio de um anúncio de clique para o WhatsApp.
...
Booliano que indica se a figurinha é animada (`true`) ou não (`false`).
