...
<!-- Scraped: 2025-12-20T17:51:13.782Z -->
...
As soluções multiparceiros permitem que parceiros de soluções e provedores de tecnologia gerenciem conjuntamente os ativos do WhatsApp dos clientes para oferecer a eles serviços de mensagens da plataforma. Por exemplo, caso você seja provedor de tecnologia e não consiga oferecer serviços de mensagens personalizados ou completos do WhatsApp aos seus clientes, será possível trabalhar com um parceiro de solução para oferecer os serviços dele.

Depois de criada e aceita via API ou Painel de Apps, o ID da solução poderá ser usado para personalizar o fluxo de Cadastro Incorporado. Os clientes integrados por meio do fluxo personalizado poderão conceder acesso a ativos a todos os parceiros de soluções.
...
## Criar soluções multiparceiros

Acesse **Painel de Apps** > **WhatsApp** > **Soluções para parceiros** para criar, aceitar e gerenciar soluções.

![](https://scontent-gru1-2.xx.fbcdn.net/v/t39.2365-6/387755976_1054085509106646_2627484372064430460_n.png?_nc_cat=100&ccb=1-7&_nc_sid=e280be&_nc_ohc=_XDIwWO4JfEQ7kNvwFbrlxF&_nc_oc=AdkoPZ5Fgg3SONaZif89juH2NhnhYV-crEhcZAX4grB1_O6u-Q2v-dhmHM8uF9Gsm60&_nc_zt=14&_nc_ht=scontent-gru1-2.xx&_nc_gid=9pqNtjHcdQjgBOorYzcfNg&oh=00_AfkjzRHDtZcRO40792XBJPHd9J2TmdwT4HXNjUOhyQyhaQ&oe=69613520)

As soluções podem ser criadas por qualquer parceiro da solução. Depois de criada, uma solicitação de solução é enviada ao parceiro convidado, que pode então usar o Painel para aceitar ou recusar. Uma vez aceita, qualquer parceiro poderá usar o ID da solução para personalizar o fluxo de Cadastro Incorporado e integrar clientes empresariais.

### Estados da solução

Os estados das soluções são exibidos no painel do **Soluções de parceiros**. As soluções podem ter os seguintes estados:
...
Os provedores de tecnologia que fazem parte de uma solução podem integrar até 200 novos clientes em um período contínuo de uma semana. Apenas os cientes novos na Plataforma do WhatsApp Business são contabilizados nesse limite.
...
![](https://scontent-gru1-1.xx.fbcdn.net/v/t39.2365-6/387758256_729453148995242_4492854088232630406_n.png?_nc_cat=101&ccb=1-7&_nc_sid=e280be&_nc_ohc=Vw3MxsXwDcQQ7kNvwESK-MD&_nc_oc=AdkwC95l9lqC0dly4l9ZM5pKOnRossdm3ZMVNvbF8IoSGpB2DkuIP3qFDoymgyDvEC8&_nc_zt=14&_nc_ht=scontent-gru1-1.xx&_nc_gid=9pqNtjHcdQjgBOorYzcfNg&oh=00_AfntsKDzikyxZCEq3il73bzOIiT1ETZZGtS5NngbddQ6Jw&oe=69611135)
...
![](https://scontent-gru1-2.xx.fbcdn.net/v/t39.2365-6/387766072_815168047024704_8866666397602417825_n.png?_nc_cat=100&ccb=1-7&_nc_sid=e280be&_nc_ohc=FEz-Ze8g3JsQ7kNvwHMb9Vu&_nc_oc=AdnsnSMkrhcIzkbYviuyG54Yzo1NvUoTNs_35AnCCybduxF3L7dgrn2Gj4KuElYRl58&_nc_zt=14&_nc_ht=scontent-gru1-2.xx&_nc_gid=9pqNtjHcdQjgBOorYzcfNg&oh=00_AfmaFw3GaVu06LaUug3OEggJaizKO_yGmGFp5_cOT4BhFg&oe=69611A91)

Use o ID do app do seu parceiro para concluir o fluxo. Como parte do fluxo de criação, você pode designar quais apps de parceiros de soluções podem ser usados por clientes empresariais integrados para enviar mensagens (**Somente eu**, **Somente meu parceiro**).

![](https://scontent-gru1-2.xx.fbcdn.net/v/t39.2365-6/466044298_1209676256996747_5273108359679787011_n.png?_nc_cat=108&ccb=1-7&_nc_sid=e280be&_nc_ohc=fNrqvSlALAEQ7kNvwEJbOOh&_nc_oc=Adn-hBh6Rv8Cd6IZgnG3mxEIG5NS90kKwV_4iKVtzBO3r3E5bQiDt803fheSCmjv5KI&_nc_zt=14&_nc_ht=scontent-gru1-2.xx&_nc_gid=9pqNtjHcdQjgBOorYzcfNg&oh=00_AfmDKaQvLptn_7_DMH68QxPBsymztDFnV0svitZSfgmAyA&oe=696111DA)
...
Além disso, um webhook [**partner\_solutions**](#partner-solutions-2) será disparado com `event` definido como `SOLUTION_CREATED` e `solution_status` como `INITIATED`. Capture o ID da solução (`solution_id`) se você for aceitar/rejeitar e gerenciar a solução via API.
...
![](https://scontent-gru2-1.xx.fbcdn.net/v/t39.2365-6/465912134_539074672234606_4001016335689190990_n.png?_nc_cat=111&ccb=1-7&_nc_sid=e280be&_nc_ohc=o5cVVuu_UqMQ7kNvwHmu5A1&_nc_oc=Adkh2mBGCmYpK1veMAlpOuEGq-21aT0XBNeLg78ofWf3O-uTVpW5j43Ln3c1qNK1Wjw&_nc_zt=14&_nc_ht=scontent-gru2-1.xx&_nc_gid=9pqNtjHcdQjgBOorYzcfNg&oh=00_AfmaHKZ_vvFaeWTMh_536XoEgqLDsFEmEnJQKNFKG17CfQ&oe=69611F71)
...
![](https://scontent-gru2-2.xx.fbcdn.net/v/t39.2365-6/465996567_886269830277358_6720016141752033956_n.png?_nc_cat=105&ccb=1-7&_nc_sid=e280be&_nc_ohc=o29p6MRa6lIQ7kNvwHNvDjG&_nc_oc=AdlDQMWWvyDQmvlWkuOy9x9xy3XNodxVZaO5Vck1kcnptEnTfKqM1ZB0hLqjtq_dU-8&_nc_zt=14&_nc_ht=scontent-gru2-2.xx&_nc_gid=9pqNtjHcdQjgBOorYzcfNg&oh=00_AfmleYNGHn4gn4kqWFwq0X508BLLB79rTGKBlHEyJ-2LVg&oe=69613A39)
...
Antes de aceitar a solução, use o ponto de extremidade [**GET /<SOLUTION\_ID>**](/documentation/business-messaging/whatsapp/reference/whatsapp-business-solution/solution-details-api#get-version-solution-id) para obter os detalhes e confirmar que tudo está correto, já que as soluções não poderão ser recusadas após o aceite.
...
Quando uma solução multiparceiros é criada ou modificada, um webhook **partner\_solutions** descrevendo a alteração será disparado.
...
### Enviar uma solicitação de desativação
...
### Aceitar uma solicitação de desativação
...
### Rejeitar uma solicitação de desativação
...
Como alternativa em caso de problemas com o webhook, você pode verificar manualmente se há clientes integrados. Para isso, use o ponto de extremidade [**GET /<BUSINESS\_PORTFOLIO\_ID>/client\_whatsapp\_business\_accounts**](/docs/marketing-api/reference/business/client_whatsapp_business_accounts#Reading), que retornará identificações das contas do WhatsApp Business (WABA, pelas iniciais em inglês) de todos os clientes recém-integrados por meio da solução.
...
### Obter soluções associadas ao seu app
...
### Obter soluções que integraram uma WABA
...
### Obter parceiros de uma solução
...
Se você não estiver hospedando o Cadastro Incorporado, mas quiser obter o [token de acesso do usuário do sistema de integração comercial](/documentation/business-messaging/whatsapp/access-tokens#business-integration-system-user-access-tokens) ("token da empresa") de um cliente empresarial integrado, será possível fazer isso usando a identificação do portfólio empresarial e a identificação da solução contidas no webhook [account\_update](#account-update) que foi disparado quando o cliente concluiu o fluxo de Cadastro Incorporado.

### Solicitação

Use o ponto de extremidade [GET /<SOLUTION\_ID>/access\_token](/documentation/business-messaging/whatsapp/reference/whatsapp-business-solution/access-token-api#Reading) e solicite o parâmetro `business_id` para obter o [token da empresa](/documentation/business-messaging/whatsapp/access-tokens#business-integration-system-user-access-tokens) de um cliente empresarial integrado.
...
Você tem várias opções para migrar ativos de clientes comerciais para e a partir de Soluções Multiparceiros. Consulte o artigo [Migrar ativos de clientes empresariais](/documentation/business-messaging/whatsapp/solution-providers/support#migrating-business-customer-assets).
