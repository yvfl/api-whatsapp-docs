...
<!-- Scraped: 2026-03-10T21:35:10.018Z -->
...
### [Flow JSON Components](https://developers.facebook.com/docs/whatsapp/flows/reference/components)

Flow JSON components.

### [Media Upload Components](https://developers.facebook.com/docs/whatsapp/flows/reference/media_upload)

Media upload components.

### [Flows API](https://developers.facebook.com/docs/whatsapp/extensions/reference/extensionsapi)
...
### [Metrics API](https://developers.facebook.com/docs/whatsapp/flows/reference/metrics_api)

Learn all about the Metrics API here.

### [Webhooks](https://developers.facebook.com/docs/whatsapp/flows/reference/flowswebhooks)
...
### [Lifecycle of a Flow](https://developers.facebook.com/docs/whatsapp/flows/reference/lifecycle)
...
](/docs/whatsapp/flows/reference/flowjson)
